...
import theDormant.util.CardArtRoller;

import java.util.ArrayList;

import static theDormant.DormantMod.*;
import static theDormant.util.Wiz.atb;
import static theDormant.util.Wiz.att;
...
public abstract class AbstractEasyCard extends CustomCard {
    ...
    public AbstractEasyCard(final String cardID, final int cost, final CardType type, final CardRarity rarity, final CardTarget target) {
        this(cardID, cost, type, rarity, target, TheDormant.Enums.DORMANT_COLOR);
    }
