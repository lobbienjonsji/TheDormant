...
import theDormant.cards.Defend;
import theDormant.cards.Strike;
import theDormant.relics.TodoItem;

import java.util.ArrayList;

import static theDormant.TheDormant.Enums.DORMANT_COLOR;
import static theDormant.DormantMod.*;

public class TheDormant extends CustomPlayer {
    ...
    static final String ID = makeID("TheDormant");
    static final CharacterStrings characterStrings = CardCrawlGame.languagePack.getCharacterString(ID);
    static final String[] NAMES = characterStrings.NAMES;
    static final String[] TEXT = characterStrings.TEXT;


    public TheDormant(String name, PlayerClass setClass) {
    ...
    public AbstractPlayer newInstance() {
        return new TheDormant(name, chosenClass);
    }
    ...
    public static class Enums {
        @SpireEnum
        public static AbstractPlayer.PlayerClass THE_DORMANT;
        @SpireEnum(name = "DORMANT_COLOR")
        public static AbstractCard.CardColor DORMANT_COLOR;
        @SpireEnum(name = "DORMANT_COLOR")
